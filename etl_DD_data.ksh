...
###########################################################################################
#
# Program: etl_DD_data.ksh
# Date:    01 April 2016 script written
# Author:  J.Turck
#
# Purpose: This script is used to process the Double Delta records. US833.
#
# User: app_etl
# 
###########################################################################################
...
# Scenario # 1 
#echo "INSERT INTO etl.select_recs ( IMUSERBUSEINSSNIND, IMUSERBUSTAXID, IMUSERBUSLOCDUNSNMB, DOCID, DOCDATA, DOCDATA_PDF, CREATDT, LASTUPDDT, DOCNM, DOCTYPCD) (SELECT CASE WHEN a.IMUSERBUSEINSSNIND ='E' THEN 'EIN' WHEN a.IMUSERBUSEINSSNIND ='S' THEN 'SSN' ELSE 'XXX' END, a.IMUSERBUSTAXID, a.IMUSERBUSLOCDUNSNMB, c.DOCID, c.DOCDATA, trim(c.DOCDATA,'.ldr')||'.pdf', b.CREATDT, b.LASTUPDDT, b.DOCNM, b.DOCTYPCD from (select distinct IMUSERBUSLOCDUNSNMB, IMUSERBUSTAXID, IMUSERBUSEINSSNIND from wosb.IMUSERINFOTBL_delta) a, wosb.DOCTBL_delta b, wosb.DOCFILEUPLOADTBL_delta c where a.IMUSERBUSLOCDUNSNMB = b.DUNS and a.IMUSERBUSTAXID = substr (b.TAXID, 2,9) and b.docid = c.docid and b.DOCACTVINACTIND = 'A' and b.LASTUPDDT >= '${PULL_DATE}' and b.DOCSTATCD IN (4, 5)); " > ${ETL_RUN}/insert_select_recs.sql

# Scenario # 2
#echo "INSERT INTO etl.select_recs ( IMUSERBUSEINSSNIND, IMUSERBUSTAXID, IMUSERBUSLOCDUNSNMB, DOCID, DOCDATA, DOCDATA_PDF, CREATDT, LASTUPDDT, DOCNM, DOCTYPCD) (SELECT CASE WHEN a.IMUSERBUSEINSSNIND ='E' THEN 'EIN' WHEN a.IMUSERBUSEINSSNIND ='S' THEN 'SSN' ELSE 'XXX' END, a.IMUSERBUSTAXID, a.IMUSERBUSLOCDUNSNMB, c.DOCID, c.DOCDATA, trim(c.DOCDATA,'.ldr')||'.pdf', b.CREATDT, b.LASTUPDDT, b.DOCNM, b.DOCTYPCD from (select distinct IMUSERBUSLOCDUNSNMB, IMUSERBUSTAXID, IMUSERBUSEINSSNIND from wosb.IMUSERINFOTBL) a, wosb.DOCTBL_delta b, wosb.DOCFILEUPLOADTBL_delta c where a.IMUSERBUSLOCDUNSNMB = b.DUNS and a.IMUSERBUSTAXID = substr (b.TAXID, 2,9) and b.docid = c.docid and b.DOCACTVINACTIND = 'A' and b.LASTUPDDT >= '01-NOV-2014' and b.DOCSTATCD IN (4, 5) and a.imuserbuslocdunsnmb in ('080183860','962622440','080198128','062291696','050160614','068729529')); " > ${ETL_RUN}/insert_select_recs.sql

# Scenario #3
echo "INSERT INTO etl.select_recs ( IMUSERBUSEINSSNIND, IMUSERBUSTAXID, IMUSERBUSLOCDUNSNMB, DOCID, DOCDATA, DOCDATA_PDF, CREATDT, LASTUPDDT, DOCNM, DOCTYPCD) (SELECT CASE WHEN a.IMUSERBUSEINSSNIND ='E' THEN 'EIN' WHEN a.IMUSERBUSEINSSNIND ='S' THEN 'SSN' ELSE 'XXX' END, a.IMUSERBUSTAXID, a.IMUSERBUSLOCDUNSNMB, c.DOCID, c.DOCDATA, trim(c.DOCDATA,'.ldr')||'.pdf', b.CREATDT, b.LASTUPDDT, b.DOCNM, b.DOCTYPCD from (select distinct IMUSERBUSLOCDUNSNMB, IMUSERBUSTAXID, IMUSERBUSEINSSNIND from wosb.IMUSERINFOTBL) a, wosb.DOCTBL_delta b, wosb.DOCFILEUPLOADTBL_delta c where a.IMUSERBUSLOCDUNSNMB = b.DUNS and a.IMUSERBUSTAXID = substr (b.TAXID, 2,9) and b.docid = c.docid and b.DOCACTVINACTIND = 'A' and b.LASTUPDDT >= '01-NOV-2014' and b.DOCSTATCD IN (4, 5) and a.IMUSERBUSLOCDUNSNMB not in ('080183860','962622440','080198128','062291696','050160614','068729529')); "  > ${ETL_RUN}/insert_select_recs.sql
